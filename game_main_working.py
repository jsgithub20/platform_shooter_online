...
class Game:
    def __init__(self, screen, connection, match_type):
        ...
        # match score
        self.match_score = {"match_type": self.match_type, "round": 0, "shooter": 0, "chopper": 0,
    ...
    def restart(self):
        ...
        self.local_active_sprite_grp = pg.sprite.Group()
        self.remote_active_sprite_grp = pg.sprite.Group()
        ...
        self.local_active_sprite_grp.add(self.player_shooter,
                                         self.fps_txt,
                                         self.match_type_txt,
                                         self.player_shooter_score)
        self.remote_active_sprite_grp.add(self.player_chopper)
    ...
    def show_start_screen(self):
        ...
        self.player_id = self.network.game_state.current_player
